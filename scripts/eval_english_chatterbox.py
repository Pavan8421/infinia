#!/usr/bin/env python3
"""Eval English Chatterbox clips — WER + speaker similarity + latency/RTF."""
...
def main() -> None:
    ...
    wav_dir = args.wav_dir or (ROOT / "outputs" / "english" / "chatterbox")
    ...
    for item in sentences:
        ...
        if not wav_path.is_file():
            print("MISSING — run scripts/run_english_chatterbox.py first")
            continue
    ...
    out_json = ROOT / "results" / "english_chatterbox_eval.json"
