"""Hindi TTS pipeline — XTTS-v2 first (Phase 4); Indic Parler-TTS comparison later."""
...
class HindiPipeline(BaseTTSPipeline):
    """XTTS-v2 Hindi with voice cloning from the reference wav."""
...
def default_hindi_pipeline(
    ...
    return HindiPipeline(
        ...
        output_dir=root / "outputs" / "hindi" / "xtts",
        device=device,
    )
