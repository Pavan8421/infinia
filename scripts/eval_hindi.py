#!/usr/bin/env python3
"""Phase 4 Hindi step 3: eval Hindi XTTS clips — WER + speaker similarity + latency/RTF."""
...
def main() -> None:
    ...
    wav_dir = args.wav_dir or (ROOT / "outputs" / "hindi" / "xtts")
    ...
    for item in sentences:
        ...
        if not wav_path.is_file():
            print("MISSING — run scripts/run_hindi.py first")
            continue
    ...
    out_json = ROOT / "results" / "hindi_xtts_eval.json"
